...
export const BADGE_STYLES: Record<string, string> = {
  yellow:
    "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-100 border-yellow-300 dark:border-yellow-700",
  blue: "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-100 border-blue-300 dark:border-blue-700",
  purple:
    "bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-100 border-purple-300 dark:border-purple-700",
  green:
    "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-100 border-green-300 dark:border-green-700",
  indigo:
    "bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-100 border-indigo-300 dark:border-indigo-700",
...
export const SECTION_STYLES: Record<string, string> = {
  yellow:
    "mb-6 border-l-4 border-yellow-500 dark:border-yellow-400 pl-4 bg-yellow-50/30 dark:bg-yellow-900/10 rounded-r",
  blue: "mb-6 border-l-4 border-blue-500 dark:border-blue-400 pl-4 bg-blue-50/30 dark:bg-blue-900/10 rounded-r",
  purple:
    "mb-6 border-l-4 border-purple-500 dark:border-purple-400 pl-4 bg-purple-50/30 dark:bg-purple-900/10 rounded-r",
  green:
    "mb-6 border-l-4 border-green-500 dark:border-green-400 pl-4 bg-green-50/30 dark:bg-green-900/10 rounded-r",
  indigo:
    "mb-6 border-l-4 border-indigo-500 dark:border-indigo-400 pl-4 bg-indigo-50/30 dark:bg-indigo-900/10 rounded-r",
