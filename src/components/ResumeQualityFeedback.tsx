...
export const ResumeQualityFeedback: React.FC<ResumeQualityFeedbackProps> = ({
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {comprehensiveFeedback && qualityScore && (
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{comprehensiveFeedback.ats_score}</div>
              ...
              <div className="text-center p-4 border rounded-lg">
                <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{qualityScore.score}</div>
              ...
              <div className="text-center p-4 border-2 border-primary rounded-lg bg-primary/5">
                <div className={`text-2xl font-bold ${getScoreColor(comprehensiveFeedback.overall_score)}`}>
                  {comprehensiveFeedback.overall_score}
                </div>
