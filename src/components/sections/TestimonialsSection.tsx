...
const testimonials = [
  ...
  {
    text: "As a career switcher, I needed my resume to stand out. ResumeAI transformed it into an ATS-friendly masterpiece.",
  ...
  {
    text: "I landed interviews at 5 Fortune 500 companies in 2 weeks. The difference was night and day after using ResumeAI.",
