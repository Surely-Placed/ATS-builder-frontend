      ...
      <Card className="p-6 h-full">
        <div className="flex flex-col h-full">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Paste your job posting URL, upload your resume, and let our AI do the rest. We
            ...
            {[
              {
                ...
                desc: "Paste the career page URL and we extract all key requirements, skills, and keywords from the job posting.",
              },
              {
                step: "2",
