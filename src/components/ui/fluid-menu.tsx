  ...
  return (
    <div className="relative w-[48px]" data-expanded={isExpanded} data-menu-container>
      ...
      <div className="relative">
        ...
        <div className="relative w-12 h-12 bg-gradient-to-br from-primary/90 to-primary cursor-pointer rounded-full group will-change-transform z-50 shadow-lg shadow-primary/20 hover:shadow-primary/30 border border-primary/30">
          {childrenArray[0]}
        </div>
