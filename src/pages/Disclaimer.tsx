            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  The information contained on AI Resume Genius ("Service") is for general information 
                  ...
                  completeness, accuracy, reliability, suitability, or availability of the Service 
                  or the information, products, services, or related graphics contained on the Service 
                  for any purpose.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  AI Resume Genius provides AI-powered resume optimization tools and recommendations. 
                  However, we do not guarantee, warrant, or represent that:
                </p>
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  ...
                  but not limited to: job market conditions, industry requirements, employer preferences, 
                  your qualifications and experience, interview performance, and competition from 
                  other candidates.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  and optimize resumes. You acknowledge and understand that:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>AI technology is not perfect and may produce errors or inaccuracies</li>
                  <li>AI recommendations are based on algorithms and patterns, not human judgment</li>
                  <li>Our AI models may not account for all industry-specific requirements or nuances</li>
                  <li>AI analysis is a tool to assist you, not a replacement for professional career advice</li>
                  <li>You are responsible for reviewing and approving all AI-generated suggestions</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>The accuracy, truthfulness, and completeness of all information in your resume</li>
                  <li>Ensuring that your resume does not contain false, misleading, or fraudulent information</li>
                  <li>Verifying that all claims, qualifications, and experiences in your resume are accurate</li>
                  <li>Complying with all applicable laws and regulations regarding resume content</li>
                  <li>Any consequences resulting from inaccurate, false, or misleading information in your resume</li>
                </ul>
                <p className="text-muted-foreground leading-relaxed mt-4">
                  We are not responsible for any misrepresentations, inaccuracies, or false information 
                  in your resume, even if such information was suggested or formatted by our Service.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  We recommend consulting with qualified professionals for personalized career advice, 
                  legal guidance, or specialized resume writing services when appropriate.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We strive to provide a reliable and uninterrupted Service, but we do not guarantee that:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  ...
                  at any time without notice. We are not liable for any loss or damage resulting 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  and "AS AVAILABLE" basis. You acknowledge that:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  <p className="text-muted-foreground mb-2">
                    <strong>Email:</strong>{" "}
                    <a href="mailto:support@airesumegenius.com" className="text-primary hover:underline">
                      support@airesumegenius.com
                    </a>
                  </p>
                  <p className="text-muted-foreground">
                    <strong>Address:</strong> AI Resume Genius, Support Department<br />
