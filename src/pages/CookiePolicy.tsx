...
const CookiePolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cookie Policy - AI Resume Genius</title>
        <meta
          name="description"
          content="Cookie Policy for AI Resume Genius. Learn about how we use cookies and similar technologies on our website."
        />
      </Helmet>
          ...
          <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  AI Resume Genius uses cookies and similar tracking technologies to enhance your 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  These cookies allow the Service to remember choices you make (such as your language 
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><strong>Theme Cookies:</strong> Remember your theme preference (light/dark mode)</li>
                </ul>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  and reporting information anonymously. This helps us improve the Service and user experience.
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li><strong>Usage Analytics:</strong> Track pages visited, time spent, and user interactions</li>
                  <li><strong>Performance Monitoring:</strong> Monitor Service performance and identify issues</li>
                  <li><strong>Error Tracking:</strong> Identify and fix technical problems</li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><strong>Retargeting Cookies:</strong> Show you relevant content based on your interests</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  They are used to remember your preferences and settings across multiple visits. 
                  The duration varies depending on the type of cookie, typically ranging from a few 
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><a href="http://www.youronlinechoices.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Your Online Choices (EU)</a></li>
                  <li><a href="http://www.networkadvertising.org/choices/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Network Advertising Initiative</a></li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  that you do not want to be tracked. Currently, there is no standard for how 
                  websites respond to DNT signals. We do not currently respond to DNT browser 
                  signals or mechanisms. However, you can control tracking through your cookie 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  the "Last Updated" date. We encourage you to review this Cookie Policy periodically.
                </p>
              </section>
