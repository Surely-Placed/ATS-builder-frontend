...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy - AI Resume Genius</title>
        <meta
          name="description"
          content="Privacy Policy for AI Resume Genius. Learn how we collect, use, and protect your personal information."
        />
      </Helmet>
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  AI Resume Genius ("we," "our," or "us") is committed to protecting your privacy. 
                  This Privacy Policy explains how we collect, use, disclose, and safeguard your 
                  information when you use our AI-powered resume optimization service ("Service"). 
                  Please read this Privacy Policy carefully. By using our Service, you agree to 
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><strong>Resume Data:</strong> We collect the resume documents you upload, including personal information, work history, education, skills, and other content contained in your resume.</li>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li><strong>Usage Data:</strong> Information about how you access and use our Service, including IP address, browser type, device information, pages visited, and time spent on pages.</li>
                  <li><strong>Cookies and Tracking Technologies:</strong> We use cookies and similar tracking technologies to track activity on our Service and store certain information. See our Cookie Policy for more details.</li>
                  <li><strong>Log Data:</strong> Server logs that may include information such as your IP address, browser type, browser version, pages visited, time and date of visit, and other statistics.</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>To communicate with you about your account, our Service, or customer support</li>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Your resume data is stored securely on our servers and is encrypted both in transit 
                  and at rest. We retain your information for as long as necessary to provide our 
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li><strong>Service Providers:</strong> We may share information with third-party service providers who perform services on our behalf, such as cloud hosting, analytics, and customer support. These providers are contractually obligated to protect your information.</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li><strong>Opt-Out:</strong> You can opt-out of marketing communications by using the unsubscribe link in our emails or contacting us.</li>
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  ...
                  <a href="mailto:privacy@airesumegenius.com" className="text-primary hover:underline">
                    privacy@airesumegenius.com
                  </a>
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  from those in your country. By using our Service, you consent to the transfer 
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    <strong>Address:</strong> AI Resume Genius, Privacy Department<br />
