...
const TermsOfService = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms of Service - AI Resume Genius</title>
        <meta
          name="description"
          content="Terms of Service for AI Resume Genius. Read our terms and conditions for using our AI-powered resume optimization service."
        />
      </Helmet>
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  By accessing or using AI Resume Genius ("Service"), you agree to be bound by these 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  AI Resume Genius is an AI-powered resume optimization platform that helps users 
                  improve their resumes for better compatibility with Applicant Tracking Systems (ATS) 
                  and enhanced job application success. Our Service includes:
                </p>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">4. User Content and Responsibilities</h2>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  and personal information. By uploading content, you grant us a limited, non-exclusive, 
                  royalty-free license to use, process, and store your content solely for the purpose 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  scheduled or unscheduled maintenance that may temporarily interrupt access to the Service.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  are displayed in USD unless otherwise stated. Subscription fees are billed in advance 
                  on a recurring basis (monthly or annually) as selected by you.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">6.2 Payment Processing</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Payments are processed through third-party payment processors. By providing payment 
                  information, you authorize us to charge your payment method for all fees associated 
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  Cancellation takes effect at the end of your current billing period. Refunds 
                  are provided in accordance with our refund policy, which may vary by subscription 
                  plan. Contact us for specific refund terms.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">6.4 Price Changes</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We reserve the right to modify subscription prices at any time. Price changes 
                  will be communicated to you in advance and will apply to subsequent billing 
                  periods. Continued use of the Service after a price change constitutes acceptance 
                  of the new pricing.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  AI Resume Genius and are protected by international copyright, trademark, patent, 
                  trade secret, and other intellectual property laws. You may not copy, modify, 
                  distribute, sell, or lease any part of our Service without our prior written consent.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  offers, or employment. Resume optimization is one factor in job application success, 
                  and outcomes depend on numerous factors beyond our control.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">8.3 Limitation of Liability</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, AI RESUME GENIUS SHALL NOT BE LIABLE FOR 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  You agree to defend, indemnify, and hold harmless AI Resume Genius and its officers, 
                  directors, employees, and agents from and against any claims, liabilities, damages, 
                  losses, and expenses, including reasonable legal fees, arising out of or in any 
                  way connected with your use of the Service, your violation of these Terms, or 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  account deletion feature in your account settings.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  <p className="text-muted-foreground mb-2">
                    <strong>Email:</strong>{" "}
                    <a href="mailto:legal@airesumegenius.com" className="text-primary hover:underline">
                      legal@airesumegenius.com
                    </a>
                  </p>
                  <p className="text-muted-foreground">
                    <strong>Address:</strong> AI Resume Genius, Legal Department<br />
