            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  Resume Genius and are protected by international copyright, trademark, patent,
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  You agree to defend, indemnify, and hold harmless AI Resume Genius and its
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  <p className="text-muted-foreground mb-2">
                    <strong>Email:</strong>{" "}
                    <a
                      href="mailto:legal@airesumegenius.com"
                  ...
                  <p className="text-muted-foreground">
                    <strong>Address:</strong> AI Resume Genius, Legal Department
                    <br />
